...
public class UserRestAPI {
    ...
    public Response updatePassword(
        ...
        if (!com.flipkart.restController.UserAuth.isUserLogin(authKey)) {
            ...
            if (loggedIn) {
                ...
                switch (userRole) {
                    case STUDENT:
                        ...
                        authKey = com.flipkart.restController.UserAuth.loginStudent(userId);
                        break;
                    case ADMIN:
                        authKey = com.flipkart.restController.UserAuth.loginAdmin(userId);
                        break;
                    case PROFESSOR:
                         authKey = com.flipkart.restController.UserAuth.loginProfessor(userId);
                        break;
